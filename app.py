...
.heroArtwork{position:relative;z-index:2;display:block;width:100%;height:auto;max-height:360px;object-fit:contain;margin:0 auto}.heroFallback{display:none}.hero:before,.hero:after{content:"";position:absolute;border-radius:50%;background:#ffffff14}
...
<body><div class="app"><div class="hero">\n  <img class="heroArtwork" src="/header.svg" alt="SeniScan AI — Imbas, Kenal, Faham, Ingat">\n  <div class="heroFallback">
